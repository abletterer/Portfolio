...
<!--<![endif]-->
<head>
<title>Halftone | Portfolio</title>
<meta charset="utf-8">
...
<?php require_once("./header.php"); ?>
  ...
  <div role="main" id="main" class="cf">
    ...
    <ul class="work-list cf">
      <li> <a href="project.html" class="thumb"> <img src="img/dummies/t1.jpg" alt="">
        <div class="img-overlay"><i class="icon-plus-sign"></i></div>
        </a> <a href="project.html"  class="excerpt">Pellentesque habitant morbi tristique senectus</a>
        <div class="categories"><a href="#">webdesign, </a><a href="#">print, </a><a href="#">photo, </a></div>
      </li>
      <li> <a href="project.html" class="thumb"> <img src="img/dummies/t2.jpg" alt="">
        <div class="img-overlay"><i class="icon-plus-sign"></i></div>
        </a> <a href="project.html"  class="excerpt">Pellentesque habitant morbi tristique senectus</a>
        <div class="categories"><a href="#">webdesign, </a><a href="#">print, </a><a href="#">photo, </a></div>
      </li>
      <li> <a href="project.html" class="thumb"> <img src="img/dummies/t3.jpg" alt="">
        <div class="img-overlay"><i class="icon-plus-sign"></i></div>
        </a> <a href="project.html"  class="excerpt">Pellentesque habitant morbi tristique senectus</a>
        <div class="categories"><a href="#">webdesign, </a><a href="#">print, </a><a href="#">photo, </a></div>
      </li>
