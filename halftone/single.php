...
<?php require_once("./header.php"); ?>
  ...
  <div role="main" id="main" class="cf">
    ...
    <div id="posts-list" class="cf">
      <article class="cf">
        <div class="feature-image"> <a href="single.html"><img src="img/dummies/672x400a.jpg" alt=""></a> </div>
        <div class="entry-left-data">
          <div class="entry-date"><span class="m">JAN</span><span class="d">23</span></div>
          <a href="#" class="comments">161</a> </div>
        <div class="entry-right-data"> <a href="single.html" class="post-heading">LOREM IPSUM DOLOR</a>
          <div class="meta"> <span class="user"><a href="#">By LuisZuno, </a></span> <span class="tags"><a href="#">red</a>, <a href="#">cyan</a>, <a href="#">white</a>, <a href="#">blue</a></span> </div>
        ...
        <ul class="commentlist">
          <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1 parent" id="comment-1">
            <div id="div-comment-1" class="comment-body">
              <div class="comment-author vcard"> <img alt="" src="img/gravatar.png" class="avatar avatar-60 photo" height="60" width="60"> <cite class="fn">admin</cite> <span class="says">says:</span> </div>
            ...
            <ul class="children">
              <li class="comment byuser comment-author-admin bypostauthor odd alt depth-2" id="comment-4">
                <div id="div-comment-3" class="comment-body">
                  <div class="comment-author vcard"> <img alt="" src="img/gravatar.png" class="avatar avatar-60 photo" height="60" width="60"><cite class="fn">admin</cite> <span class="says">says:</span> </div>
                  <div class="comment-meta commentmetadata"><a href="#">June 18, 2012 at 6:09 pm</a> </div>
      ...
      <!-- Respond -->
      <div id="respond">
        <h4 class="heading">Leave a Reply <small><a rel="nofollow" id="cancel-comment-reply-link" href="#respond" style="display:none;">Cancel reply</a></small></h4>
