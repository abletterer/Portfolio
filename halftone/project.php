...
<?php require_once("./header.php"); ?>
  ...
  <div role="main" id="main" class="cf">
    ...
    <div id="project-gallery">
      <div class="thumb"><img src="img/dummies/p1.jpg" alt=""></div>
      <div class="thumb"><img src="img/dummies/p2.jpg" alt=""></div>
    </div>
    <div id="project-info">
      ...
      <p><a href="#" class="link-button">Launch Project</a></p>
    ...
    <div class="related-projects">
      ...
      <ul class="related-list cf">
        <li> <a href="#" class="thumb"><img src="img/dummies/t1.jpg" alt=""></a> <a href="#" class="heading">Pellentesque habitant morbi</a> </li>
        <li> <a href="#" class="thumb"><img src="img/dummies/t2.jpg" alt=""></a> <a href="#" class="heading">Pellentesque habitant morbi</a> </li>
        <li> <a href="#" class="thumb"><img src="img/dummies/t3.jpg" alt=""></a> <a href="#" class="heading">Pellentesque habitant morbi</a> </li>
      </ul>
    </div>
    <!-- ENDS related -->
  </div>
